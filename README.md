...
```shell
git clone https://github.com/hienntk/hien-blog
```
...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/hien-blog/` (actual URL will be outputted in the CLI) in a browser.
...
`hugo.yaml`:
```yaml
baseURL: 'https://hienntk.github.io/hien-blog'
title: 'Qubt Theme'
```
...
links:
  - github: https://github.com/hienntk/hien-blog
  - link: https://github.com/hienntk/hien-blog#readme
...
`https://hienntk.github.io/hien-blog`